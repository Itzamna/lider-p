<? title('Вельш Корги Пемброк, Цвергпинчер') ?>
<table border="0" class="layout">
    ...
    <tbody>
        <tr>
            <td valign="top">
                <div class="holster">
                    <div class="block_container s3 b-text b-static-text user_css_12816005438" id="e_127779588359"><span><img border="0" src="../public/images/stories/breed/korzhiki.jpg" /></span></div>
                </div>
            </td>
            <td>
                <div class="holster">
